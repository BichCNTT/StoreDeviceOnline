package com.example.ominext.store.ui.technologyequipment;
...
import com.example.ominext.store.ui.laptop.ProductAdapter;
import com.example.ominext.store.ui.laptop.ProductPresenter;
import com.example.ominext.store.ui.laptop.ProductView;
...
public class TechnologyEquipmentFragment extends Fragment implements OnItemClickListener, ProductView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public TechnologyEquipmentFragment() {
    }

    public static TechnologyEquipmentFragment newInstance() {
        TechnologyEquipmentFragment fragment = new TechnologyEquipmentFragment();
        return fragment;
    }
    ...
    private void init() {
        change(change);
        mPresenter = new ProductPresenter(TechnologyEquipmentFragment.this.getContext(), this);
    ...
    private void refreshContent() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                mPresenter.getListTechnologyEquipment();
        ...
        switch (view.getId()) {
            ...
            case R.id.img_sort:
                ...
                if (chose.equals("Giá từ thấp đến cao")) {
                    mPresenter.getListSortUpTechnologyEquipment();
                } else {
                    mPresenter.getListSortDownTechnologyEquipment();
                }
                adapter.notifyDataSetChanged();
                break;
        }
