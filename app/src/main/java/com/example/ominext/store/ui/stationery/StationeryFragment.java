package com.example.ominext.store.ui.stationery;
...
public class StationeryFragment extends Fragment implements OnItemClickListener, ProductView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        change(change);
        mPresenter = new ProductPresenter(StationeryFragment.this.getContext(), this);
        ...
        switch (view.getId()) {
            ...
            case R.id.img_sort:
                ...
                if (chose.equals("Giá từ thấp đến cao")) {
                    mPresenter.getListSortUpStationery();
                } else {
                    mPresenter.getListSortDownStationery();
                }
                adapter.notifyDataSetChanged();
                break;
        }
