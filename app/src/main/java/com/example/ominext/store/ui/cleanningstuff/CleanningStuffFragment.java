package com.example.ominext.store.ui.cleanningstuff;
...
public class CleanningStuffFragment extends Fragment implements OnItemClickListener, ProductView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static CleanningStuffFragment newInstance() {
        CleanningStuffFragment fragment = new CleanningStuffFragment();
        return fragment;
    }
    ...
    private void refreshContent() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                mPresenter.getListCleanningStuff();
        ...
        switch (view.getId()) {
            ...
            case R.id.img_sort:
                ...
                if (chose.equals("Giá từ thấp đến cao")) {
                    mPresenter.getListSortUpCleanningStuff();
                } else {
                    mPresenter.getListSortDownCleanningStuff();
                }
                adapter.notifyDataSetChanged();
                break;
        }
