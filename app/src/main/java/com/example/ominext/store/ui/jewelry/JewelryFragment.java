package com.example.ominext.store.ui.jewelry;
...
public class JewelryFragment extends Fragment implements OnItemClickListener, ProductView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        change(change);
        mPresenter = new ProductPresenter(JewelryFragment.this.getContext(), this);
        ...
        switch (view.getId()) {
            ...
            case R.id.img_sort:
                ...
                if (chose.equals("Giá từ thấp đến cao")) {
                    mPresenter.getListSortUpJewelry();
                } else {
                    mPresenter.getListSortDownJewelry();
                }
                adapter.notifyDataSetChanged();
                break;
        }
