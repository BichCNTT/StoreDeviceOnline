package com.example.ominext.store.ui.fashion;
...
public class FashionFragment extends Fragment implements OnItemClickListener, ProductView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        change(change);
        mPresenter = new ProductPresenter(FashionFragment.this.getContext(), this);
        ...
        switch (view.getId()) {
            ...
            case R.id.img_sort:
                ...
                if (chose.equals("Giá từ thấp đến cao")) {
                    ...
                    mPresenter.getListSortDownFashion();
                }
                adapter.notifyDataSetChanged();
                break;
        }
