package com.example.ominext.store.ui.kitchen;
...
public class KitchenFragment extends Fragment implements OnItemClickListener, ProductView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        change(change);
        mPresenter = new ProductPresenter(KitchenFragment.this.getContext(), this);
        ...
        switch (view.getId()) {
            ...
            case R.id.img_sort:
                ...
                if (chose.equals("Giá từ thấp đến cao")) {
                    ...
                    mPresenter.getListSortDownKitchen();
                }
                adapter.notifyDataSetChanged();
                break;
        }
