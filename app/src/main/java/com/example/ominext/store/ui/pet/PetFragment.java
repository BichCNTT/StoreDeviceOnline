package com.example.ominext.store.ui.pet;
...
public class PetFragment extends Fragment implements OnItemClickListener, ProductView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        change(change);
        mPresenter = new ProductPresenter(PetFragment.this.getContext(), this);
